  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navMenu">
      ...
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item"><a class="nav-link" href="/travels/dashboard/users/login.php">Packages</a></li>
        <li class="nav-item"><a class="nav-link" href="/travels/dashboard/users/login.php">Hotels</a></li>
        <li class="nav-item"><a class="nav-link" href="/travels/dashboard/users/login.php">Destinations</a></li>
        <li class="nav-item"><a class="nav-link" href="/travels/dashboard/users/login.php">Services</a></li>
        <li class="nav-item"><a class="nav-link" href="/travels/dashboard/users/login.php">About </a></li>
        <li class="nav-item"><a class="nav-link" href="/travels/dashboard/users/login.php">FAQ</a></li>
        <li class="nav-item"><a class="nav-link" href="/travels/dashboard/Contacts/create.php">Contact</a></li>
      </ul>
      <ul>
      <a href="/travels/dashboard/users/login.php" class="btn btn-primary rounded-pill px-4">Login</a>
    
       <a href="/travels/dashboard/users/register.php" class="btn btn-primary rounded-pill px-4">Register</a>
</ul>
    </div>
  </div>
</nav>
    ...
    <div class="col-md-4">
      <div class="card shadow h-100 rounded-4 overflow-hidden">
        ...
        <div class="card-body">
          ...
          <a href="/travels/dashboard/users/login.php?packag_id=<?= $pkg['id'] ?>" class="btn btn-outline-primary w-100">Book Now</a>
        </div>
      </div>
    </div>
  <?php endwhile; ?>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100 rounded-4 overflow-hidden">
        ...
        <div class="card-body">
          ...
          <a href="/travels/dashboard/users/login.php?id=<?= $post['id'] ?>" class="btn btn-sm btn-primary">Read More</a>
        </div>
      </div>
    </div>
  <?php endwhile; ?>
...
<?php endif; ?>
  ...
  <section class="destinations py-5 bg-light">
    <div class="container">
      ...
      <div class="row g-4">
        <div class="col-md-4"><img src="/travels/front/images/5.jpg" class="img-fluid rounded hover-zoom" alt="Cairo" /></div>
        <div class="col-md-4"><img src="/travels/front/images/6.jpg" class="img-fluid rounded hover-zoom" alt="Dubai" /></div>
        <div class="col-md-4"><img src="/travels/front/images/7.jpeg" class="img-fluid rounded hover-zoom" alt="Paris" /></div>
      </div>
    </div>
  </section>
